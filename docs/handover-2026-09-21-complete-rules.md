...
subtitle: "Every agreed rule and regulation, everything built and changed 12–21 September 2026, how the office reviews work, and how to restore"
date: "21 September 2026 · live version v2026-09-21-2 · restore tag restore-2026-09-21-already-paid"
---
...
# Part 2 — Pay rules (B&W rate rules v4, owner 15 Sep 2026)
...
Examples: Warehouse Mon 08–16 = R650 · Event Mon 05–16 = R930 · Event Sun 07–12 = R600 · Music Bus Sat 08–22 = R1 470 · Petrus Fri 20:00–01:00 = R420 · Event Sat 22:00–02:00 = R430.

**Staff**: Bhekizitha, Brian, Daniel, Erence, Erick, Isaac, John, Joshua, Patrick, Solomon, Thandanani, Thina — general R90 base. Givemore — House R62,50 / Team Assistance R90. Takavaudza — House-Garden R62,50 / Warehouse Team R90. Lebo — R62,50. Petrus — R81,25. Sharleen — fixed weekly.
...
| Tag / folder | State |
|---|---|
| `restore-2026-09-21-already-paid` | **Live now (v2026-09-21-2)** |
...
```
git checkout restore-2026-09-21-already-paid
npm run build
npx wrangler pages deploy dist --project-name bw-productions --branch main --commit-dirty=true
curl https://bwprodsystem.co.za/wages-version      # expect v2026-09-21-2
```
