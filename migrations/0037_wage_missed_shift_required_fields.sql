-- Missed-shift support: keep claim-week metadata, previous-payroll flag,
-- backend-only review notes, and manual overlap review items in sync on the
-- live wage draft table.
